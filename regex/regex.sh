...
sed -E 's/\* sandwich with ([a-zA-Z\.]+) ([a-zA-Z ]+)/1. \1\n2. \2\n/' < r2_input.txt > r2_output.txt #Like the previous expression, this expression uses sed to reformat, but with the third input file to the output file using regex.
